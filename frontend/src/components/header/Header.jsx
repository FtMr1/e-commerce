            ...
            <div className="header-wrapper">
                ...
                <nav className="navigation">
                  <ul className="menu-list">
                    ...
                    <li className="menu-list-item megamenu-wrapper">
                      <Link to={"/shop"} className={`menu-link ${pathName === "/shop" && "shop"}`}>
                        Shop
                        <i className="bi bi-chevron-down"></i>
                      </Link>
                      <div className="menu-dropdown-wrapper">
                        <div className="menu-dropdown-megamenu">
                          ...
                          <div className="megamenu-single">
                            <a href="#">
                              <img src="/imgimg/mega-menu.jpg" alt="" />
                            </a>
              ...
              <div className="header-right">
                <div className="header-right-links">
                  <Link to={"/auth"} className={`header-account ${pathName === "/auth" && "active"}}`}>
                    <i className="bi bi-person"></i>
                  </Link>
                  <button onClick={()=>setIsSearch(true)} className="search-button">
                  ...
                  <div className="header-cart">
                    <Link to={"/cart"} className={`header-cart-link ${pathName === "/cart" && "active"}}`}>
